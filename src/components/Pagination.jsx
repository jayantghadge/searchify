...
import Logo from "../assets/searchify-logo.png";
    ...
    <div className="flex flex-col items-center py-14 max-w-[700px]">
      <div className="relative text-[#4285f4]">
        {queries.previousPage && (
          ...
          >
            <FiChevronLeft size={20} className="mt-5 cursor-pointer" />
        ...
        {queries.nextPage && (
          ...
          >
            <FiChevronRight size={20} className="mt-5 cursor-pointer" />
            <span className="cursor-pointer absolute left-[-5px] top-[30px] hidden md:block">
              Next
            </span>
          </div>
